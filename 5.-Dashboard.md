...
* Circle Pokemon scans IV for nearby (~70m) Pokemon at exactly the coords specified
...
* Circle Smart Pokemon scans IV for nearby (~70m) Pokemon at exactly the coords specified
  * Name: A unique name of the Instance.
  * Timezone offset: Not used.
  * Min Level: Minimum worker level to be used. Set to 30 to get the same IV.
  * Max Level: Maximum worker level to be used.
...
* Circle Raid scans for nearby (~650m) raids at exactly the coords specified
  * Name: A unique name of the Instance
  * Timezone offset: Not used.
...
* Auto Quest Scans all Pokestop in the geofence for quests
  * Name: A unique name of the Instance
...
* Leveling
  ...
  * Max Level: Maximum worker level to be used. Set to 29 to stop when level 20 is reached.
