...
* Enable Clearing of removed Pokestops/Gyms: RDM will automatically clear any pokestops that are not found/possibly removed. Pokestops turned into a gym are not cleared automatically, you can copy pokestop information to gym manually by clicking `Convert Pokestops to Gyms` in Dashboard-Utilities.
