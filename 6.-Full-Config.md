Config example is located in `resources/config`. Keep [default.json](../blob/master/resources/config/default.json) unchanged.

Download `local.example.json` and modifiy it if needed.
